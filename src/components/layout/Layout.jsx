...
//       {isAuthenticated && (
//         <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-deepBlue-200">
...
const Layout = ({ children }) => {
  ...
  return (
    <div className="min-h-screen bg-deepBlue-50">
      ...
      {/* Fixed Footer Navigation - Only show when authenticated and not on home/auth pages */}
      {showFooter && (
